...
> Repository development instructions for **outbox** (Shared Package).
> Stack: python-package. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

Omnixys shared transactional outbox package.

- Repository path: `packages/python/outbox` (relative to the Omnixys root)
...
src/outbox/ transactional outbox
...
Outbox mechanics are cross-cutting infrastructure.
